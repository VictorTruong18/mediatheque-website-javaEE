	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" method="post" action="ServicesAbonnes">
					...
					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="submit" name="choixAbonne" id="reservationDoc" value="Reserver un document">
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-16" >
						<input class="input100" type="submit" name="choixAbonne" id="emprunterDoc" value="Emprunter un document">
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="submit" name="choixAbonne" id="rendreDoc" value="Rendre un document">
						<span class="focus-input100"></span>
					</div>
