...
<body>
	...
	<h1>Voici la liste des Documents disponible pour : <%= session.getAttribute("username") %></h1>
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<% List<Document> docs = (List<Document>)request.getAttribute("docDispo"); %>
			...
			<form method="post" action="EmprunterDocument">
				<img src="<%= couverture %>" style="max-height:250px; max-width: 250px;"/>
				<h1>Titre : <%= titre %> par <%= auteur %></h1>
				<h3>TYPE : <%= statut %></h3>
				<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="submit" name="emprunterDoc" id="emprunterDoc" value="Emprunter">
